    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.screenshareEnabled.observe(this) { enabled ->
            ...
            binding.screenShare.setImageResource(
                if (enabled) com.klinechat.webrtcsdk.R.drawable.baseline_cast_connected_24
                else com.klinechat.webrtcsdk.R.drawable.baseline_cast_24
            )
        }
        ...
        lifecycleScope.launchWhenCreated {
            viewModel.permissionAllowed.collect { allowed ->
                val resource = if (allowed) com.klinechat.webrtcsdk.R.drawable.account_cancel_outline else com.klinechat.webrtcsdk.R.drawable.account_cancel
